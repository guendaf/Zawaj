...
class ProfilRecherche
{
    ...
    {
        $this->villeHabRecherche = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * @return ProfilRecherche
     */
    public function addVilleHabRecherche(\Zawaj\FichesCandidatBundle\Entity\CP $villeHabRecherche)
    {
        $this->villeHabRecherche[] = $villeHabRecherche;
    ...
    /**
     * Remove villeHabRecherche
     *
     * @param \Zawaj\FichesCandidatBundle\Entity\CP $villeHabRecherche
     */
    public function removeVilleHabRecherche(\Zawaj\FichesCandidatBundle\Entity\CP $villeHabRecherche)
    {
        $this->villeHabRecherche->removeElement($villeHabRecherche);
    }
}

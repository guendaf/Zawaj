...
class DomaineProfessionType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Zawaj\FichesCandidatBundle\Entity\DomaineProfession'
        ));
    }
    ...
    {
        return 'zawaj_fichescandidatbundle_domaineprofession';
    }
}
